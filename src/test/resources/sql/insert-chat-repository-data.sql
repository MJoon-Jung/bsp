...
INSERT INTO `post` (`id`, `content`, `reward`, `item_name`, `street`, `location`, `status`,
                    `trade_type`, `created_at`, `updated_at`, `user_id`, `finder_id`)
VALUES (3, 'This is content exmaple2', 20000, 'headset', '서울특별시 광진구 자양동 234-567',
        Point(36.423142, 124.321312), 'PENDING', 'DIRECT', '2018-08-21 05:23:10', null, 2, null);

INSERT INTO `chat_room` (`id`, `post_id`, `created_at`, `updated_at`)
VALUES (1, 1, '2018-06-15 11:40:21', null);
INSERT INTO `chat_room` (`id`, `post_id`, `created_at`, `updated_at`)
VALUES (2, 2, '2018-06-15 11:40:21', null);
...
INSERT INTO `chat_room_member` (`id`, `chat_room_id`, `user_id`, `created_at`, `updated_at`)
VALUES (3, 2, 1, '2018-06-15 11:40:21', '2018-06-15 11:40:22');
INSERT INTO `chat_room_member` (`id`, `chat_room_id`, `user_id`, `created_at`, `updated_at`)
VALUES (4, 2, 2, '2018-06-15 11:40:21', '2020-01-01 11:40:21');

INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (1, 2, 1, 'This is chat example', 'MESSAGE', '2018-06-15 11:40:23', null);
INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (2, 2, 2, 'This is chat example', 'MESSAGE', '2018-06-15 11:40:23', null);
INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (3, 2, 1, 'This is chat example', 'MESSAGE', '2019-06-15 11:40:23', null);
INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (4, 2, 2, 'This is chat example', 'MESSAGE', '2021-06-15 11:40:24', null);
INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (5, 2, 1, 'This is chat example', 'MESSAGE', '2021-06-15 11:40:25', null);
INSERT INTO `chat` (`id`, `chat_room_id`, `user_id`, `content`, `type`, `created_at`, `updated_at`)
VALUES (6, 2, 2, 'This is chat example', 'MESSAGE', '2021-06-15 11:40:26', null);