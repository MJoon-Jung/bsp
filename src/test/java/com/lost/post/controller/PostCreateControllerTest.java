...
class PostCreateControllerTest {
    ...
    void should_success_post_without_any_image() throws Exception {
        ...
        mockMvc.perform(post("/api/posts")
                ...
                .andExpect(jsonPath("$.itemName").value("airpods"))
                .andExpect(jsonPath("$.address.street").value("서울시 광진구 자양동 123-123"))
                .andExpect(jsonPath("$.address.latitude").value(38.123456))
                .andExpect(jsonPath("$.address.longitude").value(126.123456))
    ...
    void should_success_post_with_any_image() throws Exception {
        ...
        ImageCreate imageCreate3 = ImageCreate.builder()
                ...
                .fileName("abcdef_abc.jpg")
                .build();
        ImageCreateRequest imageCreateRequest = ImageCreateRequest.builder()
